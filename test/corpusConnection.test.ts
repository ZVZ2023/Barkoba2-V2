...
function game(): GameRecord {
  return {
    ...
    composer_kind: "ai", racer_kind: "human", racer_provider: null, racer_engine_tier: null, difficulty: "easy", clue_mode: "none", experience_mode: null,
    question_count: 1, question_count_high_water_mark: 1, ambiguous_count: 0, qa_log: [entry()],
