...
function hhGame(o: Partial<GameRecord> = {}): GameRecord {
  return {
    ...
    private_target: false, composer_kind: "human", racer_kind: "human", racer_provider: null, racer_engine_tier: null,
    difficulty: null, clue_mode: null, experience_mode: null, question_count: 0, question_count_high_water_mark: 0, ambiguous_count: 0,
...
test("single-human modes keep working without recorded seats", () => {
  ...
  const legacy = hhGame({
    composer_kind: "human", racer_kind: "ai", racer_provider: null, racer_engine_tier: null,
