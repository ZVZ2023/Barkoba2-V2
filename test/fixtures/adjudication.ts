...
export const ADJUDICATION_FIXTURES: AdjudicationFixture[] = [
  ...
  { id: "cat-7", category: "category_vs_instance", target: "MuShu", clarification: "my own dog, one particular individual animal named MuShu", guess: "dog", language: "en", expect: "incorrect", note: "V2.1.1.2 field regression, second of a pair with inst-6. The Racer reached the right category and stopped there. 'dog' names a kind with millions of members; the locked target is one individual, so it does not resolve. Played in Hungarian, where the guess was 'kutya' — the principle is language-independent, so it is recorded once in English alongside the rest of this category." },
